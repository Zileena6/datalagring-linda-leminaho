        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompetenceName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseInstances_Courses_CourseCode",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorCompetence", x => new { x.CompetencesId, x.InstructorsId });
                    table.ForeignKey(
                        name: "FK_InstructorCompetence_Competences_CompetencesId",
                        column: x => x.CompetencesId,
                        principalTable: "Competences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructorCompetence_Participants_InstructorsId",
            ...
            migrationBuilder.CreateTable(
                name: "CourseInstanceInstructors",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseInstanceInstructors", x => new { x.CourseInstanceId, x.InstructorsId });
                    table.ForeignKey(
                        name: "FK_CourseInstanceInstructors_CourseInstances_CourseInstanceId",
                        column: x => x.CourseInstanceId,
                        principalTable: "CourseInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseInstanceInstructors_Participants_InstructorsId",
                        column: x => x.InstructorsId,
                        principalTable: "Participants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseInstanceInstructors_InstructorsId",
                table: "CourseInstanceInstructors",
                column: "InstructorsId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseInstances_CourseCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorCompetence_InstructorsId",
                table: "InstructorCompetence",
                column: "InstructorsId");
